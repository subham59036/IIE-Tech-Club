/**
 * components/student/NotificationsTab.tsx
 * Personal notification feed for the logged-in student.
 */
...
export default function StudentNotificationsTab({ onForceLogout }: { onForceLogout: () => void }) {
